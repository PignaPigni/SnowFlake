...
public class EditingPagePanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        generateButton.setText("Save PNG");
        ...
        generateButton2.setBackground(new java.awt.Color(204, 255, 51));
        generateButton2.setFont(new java.awt.Font("Verdana", 0, 48)); // NOI18N
        generateButton2.setForeground(new java.awt.Color(153, 153, 0));
        generateButton2.setText("Save SVG");
    ...
    private void pngFileChooserButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pngFileChooserButtonActionPerformed
        this.livePreviewPanel.selectPngFile();
